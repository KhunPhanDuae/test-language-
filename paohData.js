...
const paohBasicData = {
    ...
    toneSets: {
        set1: [
            { paoh: 'အ', roman: 'a1' }, { paoh: 'အꩻ', roman: 'a2' }, { paoh: 'အာ', roman: 'aa1' }, { paoh: 'အာꩻ', roman: 'aa2' }, { paoh: 'အား', roman: 'aa4' }, { paoh: 'အာႏ', roman: 'aa3' },
            { paoh: 'အိ', roman: 'i1' }, { paoh: 'အိꩻ', roman: 'i2' }, { paoh: 'အီ', roman: 'ii1' }, { paoh: 'အီꩻ', roman: 'ii2' }, { paoh: 'အီး', roman: 'ii4' }, { paoh: 'အီႏ', roman: 'ii3' },
            { paoh: 'အု', roman: 'u1' }, { paoh: 'အုꩻ', roman: 'u2' }, { paoh: 'အူ', roman: 'uu1' }, { paoh: 'အူꩻ', roman: 'uu2' }, { paoh: 'အူး', roman: 'uu4' }, { paoh: 'အူႏ', roman: 'uu3' },
            { paoh: 'အေ့', roman: 'e1' }, { paoh: 'အေ့ꩻ', roman: 'e2' }, { paoh: 'အေ', roman: 'ae1' }, { paoh: 'အေꩻ', roman: 'ae2' }, { paoh: 'အေး', roman: 'ae4' }, { paoh: 'အေႏ', roman: 'ae3' },
            { paoh: 'အဲ့', roman: 'ea1' }, { paoh: 'အဲ့ꩻ', roman: 'ea2' }, { paoh: 'အဲ', roman: 'eā1' }, { paoh: 'အဲꩻ', roman: 'eā2' }, { paoh: 'အဲး', roman: 'eā4' }, { paoh: 'အဲႏ', roman: 'eā3' },
            { paoh: 'အုဲင့်', roman: 'oing1' }, { paoh: 'အုဲင့်ꩻ', roman: 'oing2' }, { paoh: 'အုဲင်', roman: 'oeng1' }, { paoh: 'အုဲင်ꩻ', roman: 'oeng2' }, { paoh: 'အုဲင်း', roman: 'oeng4' }, { paoh: 'အုဲင်ႏ', roman: 'oeng3' },
            { paoh: 'အော့', roman: 'aw1' }, { paoh: 'အော့ꩻ', roman: 'aw2' }, { paoh: 'အော်', roman: 'aaw1' }, { paoh: 'အော်ꩻ', roman: 'aaw2' }, { paoh: 'အေား', roman: 'aaw4' }, { paoh: 'အောႏ', roman: 'aaw3' },
            { paoh: 'အို့', roman: 'o1' }, { paoh: 'အို့ꩻ', roman: 'o2' }, { paoh: 'အို', roman: 'ou1' }, { paoh: 'အိုꩻ', roman: 'ou2' }, { paoh: 'အိုး', roman: 'ou4' }, { paoh: 'အိုႏ', roman: 'ou3' },
